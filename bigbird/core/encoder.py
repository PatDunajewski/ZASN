...
class PostnormEncoderLayerAlbert(tf.keras.layers.Layer):
  """Encoder layer of a transformer in ALBERT style.
  ...
  def __init__(self,
               ...
               seed=None,
               name=None):
    """Constructor of an encoder layer of a transformer in ALBERT style.
    ...
    Args:
      ...
      embbedings_size: (optional) int. Size of the smaller dimension, taken from ALBERT innovation.
    ...
    """
    super(PostnormEncoderLayerAlbert, self).__init__(name=name)
    ...
    with tf.compat.v1.variable_scope(name):
      ...
      with tf.compat.v1.variable_scope("intermediate"):
        ...
        if embeddings_size >= hidden_size:
        ...
        #Albert innovation
          ...
          self.factorization_layer_in = utils.Dense2dLayer(
              hidden_size, embeddings_size,
              utils.create_initializer(initializer_range),
              intermediate_act_fn, "denseAlbertin")
          self.factorization_layer_out = utils.Dense2dLayer(
              embeddings_size, intermediate_size,
              utils.create_initializer(initializer_range),
              intermediate_act_fn, "denseAlbertout")
  ...
  def call(self,
    ...
    if self.embeddings_size >= self.hidden_size:
      intermediate_output = self.expand_layer(attention_output)
    else:
      intermediate_output = self.factorization_layer_in(attention_output)
      intermediate_output = self.factorization_layer_out(intermediate_output)
...
class EncoderStack(tf.keras.layers.Layer):
  ...
  def __init__(self, params):
    ...
    elif params["norm_type"] == "postnormAlbert":
      encoder_class = PostnormEncoderLayerAlbert
    else:
  ...
  def call(self,
    ...
    if self.params["norm_type"] == "postnorm" or "postnormAlbert":
